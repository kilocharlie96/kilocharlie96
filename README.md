...
#### 🐾 [BaruVet.sk](https://baruvet.sk)
*An informative website for a newly opened veterinary clinic, focused on modern performance and clean design.*

* **Tech Stack:** HTML5, CSS3, Modern JS (ES6+), Vue.js, HTMX
* **Key Features:** Real-world client project, responsive design, interactive UI.
* 🔗 [**Live Demo**](https://baruvet.sk) | 📂 [**Source Code**](https://github.com/kilocharlie96/BaruVet)
